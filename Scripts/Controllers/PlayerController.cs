//Derived from SteamVR/InteractionSystem/Core/Player
//rongfei@ucsb.edu
...
// #endif
        ...
        private IEnumerator Start()
        {
            ...
            if (characterController == null)
                throw new NullComponentException("Unable to access the character controller!");
        }
        ...
        public void Draw2DDebug()
        {
            ...
            var text = (rigSteamVR.activeSelf) ? "2D Mode" : "VR";
